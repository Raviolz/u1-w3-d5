...
*/
const me = { name: "Giorgia", surname: "Ragnoli", age: 30 };
console.log(me);
...
*/
let oggettoProva = { name: "Giorgia", surname: "Ragnoli", age: 30 };
const deleteProp = (obj, string) => {
  delete obj[string];
  return obj;
};

deleteProp(oggettoProva, "age");
...
const onlyTheYears1 = (moviesArr) => {
  return moviesArr.map((movie) => movie.Year);
};

console.log(onlyTheYears(movies));
console.log(onlyTheYears1(movies));
...
*/
const selected = document.getElementById("container");
/* ESERCIZIO 21
  Scrivi una funzione per selezionare ogni tag <td> all'interno della pagina.
*/
const selected1 = document.getElementsByTagName("td");
/* ESERCIZIO 22
...
const AddNewLi = () => {
  ...
  newLi.innerText = "Nuovo elemento aggiunto";
...
Ma forse è meglio come sotto perchè come sopra rimangono i pallini*/
...
const AddClassTestToTr = () => {
  ...
  for (let i = 0; i < tr.length; i++) tr[i].classList.add("Classe-Aggiunta");
};
